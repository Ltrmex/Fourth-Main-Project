...
from inputData import filter_dataset, split_dataset, get_dataset
import inputData
...
def _load_images_and_labels(dataset, image_size, batch_size, num_threads, num_epochs, random_flip=False,
    ...
    image_paths, labels = inputData.get_image_paths_and_labels(dataset)
    images, labels = inputData.read_data(image_paths, labels, image_size, batch_size, num_epochs, num_threads,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', type=str, action='store', 
            default="/model/20170511-185253/20170511-185253.pb", dest='model_path',
                        help='Path to model protobuf graph')
    parser.add_argument('--input-dir', type=str, action='store',default="/output/intermediate", dest='input_dir',
    ...
    parser.add_argument('--classifier-path', type=str, action='store',default="output/classifier.pkl", dest='classifier_path',
                        help='Path to output trained classifier model')
